...
each route whereas class SC considers general route duration constraints. The specific instances can be found from the packages "SA.7z", "SB.7z", and "SC.7z", and their results under different parameter settings are placed in  the package "Result.7z".
